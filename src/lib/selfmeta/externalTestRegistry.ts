...
const EXTERNAL_TEST_SCIENTIFIC_PROFILES: Record<string, ExternalTestScientificProfile> = {
  abas3: profile({
    ...
    selfMetaRelation: "adaptive_daily_living mekanizmasını ve korunmuş profil varsa işlevsel denge yorumunu destekler.",
  ...
  basc3: profile({
    ...
    selfMetaRelation: "executive_behavior ve emotional yayılım yorumunu destekler.",
  ...
  beery_vmi: profile({
    ...
    selfMetaRelation: "motor_praxis ve cognitive/executive yayılım yorumuna destek sağlar.",
  ...
  bot2: profile({
    ...
    selfMetaRelation: "motor_praxis mekanizmasını güçlendirir.",
  ...
  brief_p: profile({
    ...
    selfMetaRelation: "executive_behavior ve emotional/cognitive yayılım yorumunu destekler.",
  ...
  brief2: profile({
    ...
    selfMetaRelation: "executive_behavior mekanizmasını destekler.",
  ...
  ccc2: profile({
    ...
    selfMetaRelation: "social_pragmatic ve language_social_pragmatic mekanizmalarını destekler.",
  ...
  celf_preschool3: profile({
    ...
    selfMetaRelation: "language_communication ve language_social_pragmatic mekanizmalarını destekler.",
  ...
  conners_ec: profile({
    ...
    selfMetaRelation: "executive_behavior ve emotional/cognitive yayılımını destekler.",
  ...
  dayc2: profile({
    ...
    selfMetaRelation: "development_general ve bağlamsal regülasyon yorumunu destekler.",
  ...
  dcdq07: profile({
    ...
    selfMetaRelation: "motor_praxis mekanizmasını destekler.",
  ...
  mfun: profile({
    ...
    selfMetaRelation: "motor_praxis ve executive/cognitive yayılım yorumunu destekler.",
  ...
  pdms3: profile({
    ...
    selfMetaRelation: "motor_praxis mekanizmasını ve yürütücü/bilişsel yayılımı destekler.",
  ...
  pedi_cat: profile({
    ...
    selfMetaRelation: "adaptive_daily_living, physiological_interoceptive ve daily-function yayılım yorumunu destekler.",
  ...
  pls5: profile({
    ...
    selfMetaRelation: "language_communication mekanizmasını destekler.",
  ...
  sensory_profile_2: profile({
    ...
    selfMetaRelation: "sensory_processing ve sensory-emotional formülasyonu destekler.",
  ...
  sipt: profile({
    ...
    selfMetaRelation: "motor_praxis mekanizması için yüksek değerli destekleyici testtir.",
  ...
  spm2: profile({
    ...
    selfMetaRelation: "sensory_processing ve motor/praxis ikincil bağlamını destekler.",
    sourceLinks: ["https://www.wpspublish.com/spm-2"],
    evidenceTier: "official_metadata",
  }),
  srs2: profile({
    ageRange: "2 yaş 6 aydan 18 yaşa kadar sosyal yanıtlılık/sosyal iletişim derecelendirmesi.",
  ...
  vineland3: profile({
    ...
    selfMetaRelation: "adaptive_daily_living, social-pragmatic ve korunmuş profil yorumunu destekler.",
...
function classifyResultDirection(entry?: ExternalTestFindingEntry): ExternalTestMatch["resultDirection"] {
  ...
  if (/korunmuş|korunmus|uyumlu|ortalama|normal|beklenen|tipik|klinik olmayan|eşik altı|esik alti/.test(text)) {
    if (/düşük|dusuk|beklenti alt|klinik|yüksel|yuksel|zorl|güçlük|gucluk|risk/.test(text)) return "mixed_or_contextual"
    return "expected_or_preserved"
  }
  if (/düşük|dusuk|beklenti alt|klinik|yüksel|yuksel|zorl|güçlük|gucluk|risk|sınır|sinir|atipik/.test(text)) {
...
export function analyzeExternalClinicalTests(rawText: unknown, ageMonths?: number | null): ExternalTestAnalysis {
    ...
    SUPPORTED_EXTERNAL_TESTS
      ...
      .map((test) => {
        ...
        return {
          ...
          selfMetaRelation: test.selfMetaRelation,
  ...
  const qualityFlagLines = matches
    .map((match) => {
