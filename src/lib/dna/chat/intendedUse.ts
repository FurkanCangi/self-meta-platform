...
export const DNA_INTELLIGENCE_AUDIT_NOTICE_TR =
  "Sohbet metni kalıcı geçmişe kaydedilmez. Audit; istek kimliği, mod, intent etiketi, yanıt sınıfı, motor, katalog, paket ve sözleşme sürümü, paket bütünlük özeti, otorite sözleşmesi ve politika sürümü, kullanılan otorite seti, ret durumu ve kaynak kimlikleriyle sınırlıdır; soru veya cevap metni, danışan kodu, rapor kimliği, skor ya da vaka bulgusu içermez." as const
