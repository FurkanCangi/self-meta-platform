...
export const DNA_CHAT_INTENTS: readonly DnaChatIntentDefinition[] = [
  ...
  caseIntent("case_primary_axis", "Ana klinik eksen", ["ana klinik eksen ne", "bu vakanin ana klinik ekseni ne", "birincil hipotez ne", "vakanin ana oruntusu", "baskin klinik tema"], ["kb:RISK_PROFILE_SUMMARY_RULE"]),
  caseIntent("case_primary_axis_rationale", "Ana ekseni destekleyen bulgular", ["bu vakadaki ana ekseni destekleyen bulgular neler"], ["kb:RISK_PROFILE_SUMMARY_RULE"]),
  ...
  caseIntent("case_strengths", "Göreli güçlü alanlar", ["guclu alanlar hangileri", "korunmus alanlar", "vakanin guclu yonleri", "dengeleyici alan", "bu vakadaki korunmus kapasiteler neler"], ["kb:RISK_PROFILE_PROTECTIVE_FACTORS"]),
  ...
  caseIntent("case_scores", "Vaka skorları", ["vaka skorlari ne", "bu vakanin alan skorlarini ozetle", "puanlari ozetle", "alan puanlarini goster", "skor profili nasil"], ["dna:scoring_contract"]),
  caseIntent("case_anamnesis", "Anamnez temaları", ["anamnez ne soyluyor", "bu vakanin anamnez temalari neler", "anamnez temalari", "bakimveren bildirimi", "gunluk yasam baglami"], ["kb:ANAMNESIS_INTEGRATION_GENERAL_RULE"]),
  caseIntent("case_observations", "Klinik gözlemler", ["gozlemde ne var", "bu vakanin klinik gozlemleri neler", "terapist ne gozlemlemis", "vaka gozlemleri", "gozlem bulgulari"], ["kb:REPORT_TONE_RULE"]),
  caseIntent("case_external_findings", "Ek değerlendirme bulguları", ["ek testler ne diyor", "bu vakanin ek degerlendirme bulgulari neler", "dis test bulgulari", "harici degerlendirme", "ek klinik bulgular"], ["dna:evidence_contract"]),
  caseIntent("case_evidence_alignment", "Vaka veri kanallarının uyumu", ["bu vakadaki veri kanallari birbiriyle uyumlu mu"], ["kb:ANAMNESIS_CONTRADICTION_RULE"]),
  caseIntent("case_daily_impact", "Günlük yaşama yansıyan bulgular", ["bu vakada gunluk yasama yansiyan kayitli zorlanmalar neler"], ["kb:REPORT_TONE_RULE"]),
  caseIntent("case_information_needed", "Yorumu güçlendirecek ek bilgi", ["bu vaka yorumunu guclendirmek icin hangi ek bilgiler gerekir"], ["kb:ANAMNESIS_CONTRADICTION_RULE"]),
  caseIntent("case_evidence_sources", "Rapor yorumunu destekleyen veri kanalları", ["bu rapor yorumunu dogrudan destekleyen vaka veri kanallari neler"], ["dna:evidence_contract"]),
  caseIntent("case_confidence", "Veri güveni", ["vaka guveni ne", "guven duzeyi nasil", "veri guveni bu raporda nasil", "bu yorum ne kadar guvenli", "bu vaka yorumu ne kadar kesin", "kanit guveni"], ["kb:ANAMNESIS_CONTRADICTION_RULE"]),
  caseIntent("case_limitations", "Vaka sınırlılıkları", ["vakanin sinirlari ne", "bu vakanin veri sinirliliklari neler", "eksik veri var mi", "bu raporda eksik ne var", "raporda eksik ne var", "veri sinirliliklari", "neyi bilmiyoruz"], ["kb:REGULATION_INTERPRETATION_BOUNDARY"]),
