...
const TURKISH_ASCII_WORD_REPLACEMENTS: Record<string, string> = {
  ...
  adi: "adı",
  alici: "alıcı",
  aktarilmaktadir: "aktarılmaktadır",
  ayrilma: "ayrılma",
  ayrilmasi: "ayrılması",
  ayrilmama: "ayrılmama",
  ayriliyor: "ayrılıyor",
  ...
  frustrasyon: "engellenme karşısındaki zorlanma",
  gelisim: "gelişim",
  gelisimi: "gelişimi",
  genisleme: "genişleme",
  ...
  katilma: "katılma",
  katiliyor: "katılıyor",
  kahvaltidan: "kahvaltıdan",
  kahvalti: "kahvaltı",
  kaldigi: "kaldığı",
  kaldiği: "kaldığı",
  kollarinin: "kollarının",
  kisalmasi: "kısalması",
...
const TURKISH_ASCII_REPLACEMENTS: Array<[RegExp, TextReplacement]> = [
  [/\bTuvalet:\s*SON\s+DAKKA\.\s*Susadım\s+demiyo\.?/giu, "Tuvalet ihtiyacını son anda bildiriyor ve susadığını söylemiyor."],
  [/\bIlk\b/g, "İlk"],
