...
export default function AppShell({ children }: AppShellProps) {
  return (
    <div className="dna-shell min-h-screen bg-[#eef6ff] text-slate-900">
      ...
      <div className="dna-app-frame relative mx-auto min-h-screen w-full max-w-[430px] overflow-x-hidden bg-[#f8fbff] shadow-[0_0_0_1px_rgba(148,163,184,0.26),0_28px_90px_rgba(7,27,58,0.18)] md:max-w-none md:shadow-none">
        <AppHeader />
