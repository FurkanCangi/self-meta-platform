...
import { AGE_RANGE_OPTIONS } from "@/lib/dna/ageUtils"
import {
  buildReportRelevantAnamnezSection,
} from "@/lib/dna/anamnezUtils"
import {
      ...
      <div className="dna-web-only dna-card p-5 mt-4">
        ...
        <div className="mt-1 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          ...
          <div className="grid gap-2 sm:grid-cols-3 md:flex md:flex-wrap md:justify-end">
            ...
            <button type="button" onClick={onReset} className="dna-btn-ghost px-4 py-2 text-sm font-semibold">
              Temizle
            </button>
            <button
              type="button"
          ...
          <div className="-mx-1 flex gap-2 overflow-x-auto px-1 pb-2">
            {TAB_ORDER.map((key) => {
              ...
              return (
                <button
                  key={key}
                  className={`${tabBtn(isActive)} inline-flex shrink-0 items-center gap-2`}
                  onClick={() => setTab(key)}
                  type="button"
                  title={
                    isComplete
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="dna-btn-ghost px-4 py-2 text-sm font-semibold disabled:cursor-not-allowed disabled:opacity-50"
                      disabled={!externalDraftHasContent}
                    >
                      Taslağı Temizle
                    </button>
            ...
            <div className="grid gap-2 sm:flex sm:items-center sm:justify-end">
              {prevTab ? (
                <button
                  ...
                  className="dna-btn-ghost px-4 py-2 text-sm font-semibold"
                >
