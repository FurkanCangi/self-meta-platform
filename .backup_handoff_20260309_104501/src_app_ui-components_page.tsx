            ...
            <div className="layout-specing">
                <div className="md:flex justify-between items-center">
                    ...
                    <ul className="tracking-[0.5px] inline-flex items-center sm:mt-0 mt-3">
                        <li className="inline-block capitalize text-[14px] font-bold duration-500 dark:text-white/70 hover:text-primary dark:hover:text-white"><Link href="/">Techwind</Link></li>
                        ...
                        <li className="inline-block capitalize text-[14px] font-bold text-primary dark:text-white" aria-current="page">Components</li>
                    </ul>
                </div>
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md">Primary</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-full">Primary</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-primary border-primary text-primary hover:text-white rounded-md">Primary</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-primary border-primary text-primary hover:text-white rounded-full">Primary</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary/5 hover:bg-primary border-primary/10 hover:border-primary text-primary hover:text-white rounded-md">Primary</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary/5 hover:bg-primary border-primary/10 hover:border-primary text-primary hover:text-white rounded-full">Primary</Link>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-1.25 px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md">Small</Link>
                                                </li>
                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md">Default</Link>
                                                </li>
                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="py-2.5 px-8 inline-block font-semibold tracking-wide border align-middle duration-500 text-lg text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md">Large</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md bg-primary hover:bg-primary-700 border border-primary hover:border-primary-700 text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-primary hover:bg-primary-700 border border-primary hover:border-primary-700 text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-transparent hover:bg-primary border-primary text-primary hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-transparent hover:bg-primary border-primary text-primary hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                ...
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-primary/5 hover:bg-primary border-primary/10 hover:border-primary text-primary hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link href="" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-primary/5 hover:bg-primary border-primary/10 hover:border-primary text-primary hover:text-white"><Icon.ShoppingCart className="size-4"/></Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-primary text-white text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">Primary</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-primary text-white text-[12px] font-semibold px-2.5 py-0.5 rounded-full h-5">Primary</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-transparent border border-primary text-primary text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">Primary</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-transparent border border-primary text-primary text-[12px] font-semibold px-2.5 py-0.5 rounded-full h-5">Primary</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-primary/5 border border-primary/5 text-primary text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">Primary</span>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-1">
                                                <li className="inline-block">
                                                    <span className="bg-primary/5 border border-primary/5 text-primary text-[12px] font-semibold px-2.5 py-0.5 rounded-full h-5">Primary</span>
                                                </li>
                            ...
                            <div className="" id="alerts">
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-primary border border-primary text-white block">A simple alert—check it out!</div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-primary/10 border border-primary/10 text-primary block">A simple alert—check it out!</div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-primary/10 border border-primary/10 text-primary flex items-center"><AiOutlineExclamationCircle className=" me-1"/> A simple alert—check it out!</div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <div className="space-y-3">
                                                <div className="relative px-4 py-2 rounded-md font-medium bg-primary/10 border border-primary/10 text-primary block">A simple alert—check it out! <Link href="" className="font-bold ms-1">Click here!</Link></div>
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="dropdown inline-block relative m-0.5">
                                                    <button onClick={() => setManu1(!manu1)} className="dropdown-toggle py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md" type="button">
                                                        Primary <MdKeyboardArrowDown className="text-[20px] align-middle inline-block"/>
                                                    </button>
                                                    ...
                                                    <div className={`dropdown-menu absolute start-0 m-0 z-10 w-48 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 ${manu1 ? 'block' : 'hidden'}`} >
                                                        <ul className="py-2 text-start">
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-primary">Home</Link>
                                                            </li>
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-primary">Service</Link>
                                                            </li>
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-primary">About us</Link>
                                                            </li>
                                                            <li className="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                                                            <li>
                                                                <Link href="" className="block font-medium py-1.5 px-4 hover:text-primary">Contact</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="dropdown inline-block relative m-0.5">
                                                    <button onClick={() => setManu11(!manu11)} className="dropdown-toggle size-9 inline-flex items-center justify-center tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md" type="button">
                                                        <AiOutlineSetting/>
                                                    </button>
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li>
                                                    <span className="text-primary font-semibold">.text-primary</span>
                                                </li>
                                                <li>
                            ...
                            <div className="" id="backgrounds">
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 text-white bg-primary">.bg-primary</li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary">.bg-primary</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/95">.bg-primary .opacity-95</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/90">.bg-primary .opacity-90</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/80">.bg-primary .opacity-80</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/75">.bg-primary .opacity-75</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/70">.bg-primary .opacity-70</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/60">.bg-primary .opacity-60</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/50">.bg-primary .opacity-50</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/40">.bg-primary .opacity-40</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/30">.bg-primary .opacity-30</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/25">.bg-primary .opacity-25</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/20">.bg-primary .opacity-20</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/10">.bg-primary .opacity-10</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/5">.bg-primary .opacity-5</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-primary/0">.bg-primary .opacity-0</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="inline-block w-fit mx-auto flex-wrap justify-center text-center p-2 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 rounded-md ">
                                                <li role="presentation" className="inline-block">
                                                    <button className={`${ isOpen === 0 ? 'text-white bg-primary hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-primary duration-500`} onClick={() => handleTabClick(0)}>Tab One</button>
                                                </li>
                                                <li role="presentation" className="inline-block">
                                                    <button className={`${ isOpen === 1 ? 'text-white bg-primary hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-primary duration-500`} onClick={() => handleTabClick(1)} >Tab Two</button>
                                                </li>
                                            </ul>
                                                ...
                                                <div className="lg:col-span-4 md:col-span-5">
                                                    <ul className="flex-column text-center space-y-2">
                                                        <li role="presentation">
                                                            <button className={`${ isOpen1 === 0 ? 'text-white bg-primary hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-primary duration-500`} onClick={() => handleTabClick1(0)}>Tab One</button>
                                                        </li>
                                                        <li role="presentation">
                                                            <button className={`${ isOpen1 === 1 ? 'text-white bg-primary hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-md w-full hover:text-primary duration-500`} onClick={() => handleTabClick1(1)}>Tab Two</button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <form>
                                                <div className="grid grid-cols-1 gap-5">
                                                    <div className="">
                                                        ...
                                                        <input type="text" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0 mt-2" placeholder="First Name:" id="firstname" name="name"/>
                                                    </div>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="relative mt-2">
                                                            ...
                                                            <input type="text" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0" placeholder="Username" required/>
                                                        </div>
                                                    </div>
                
                                                    <div className="">
                                                        <label className="form-label font-semibold">Your Email:</label>
                                                        <input type="email" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0 mt-2" placeholder="Email" name="email"/>
                                                    </div>
                
                                                    <div className="">
                                                        <label className="font-semibold">Select Input:</label>
                                                        <select className="form-select form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0">
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <input type="number" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0 mt-2" placeholder="Zip:" id="zipcode" name="number"/>
                                                    </div>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="flex items-center w-full mb-0">
                                                            <input className="form-checkbox size-4 appearance-none rounded border border-gray-200 dark:border-gray-800 accent-primary checked:appearance-auto dark:accent-primary focus:border-primary-300 focus:ring-0 focus:ring-offset-0 focus:ring-primary-200 focus:ring-opacity-50 me-2" type="checkbox" defaultChecked value="" id="sameaddress"/>
                                                            <label className="form-check-label text-slate-400" htmlFor="sameaddress">Checkbox 1</label>
                                                        </div>
                
                                                        <div className="flex items-center w-full mb-0">
                                                            <input className="form-checkbox size-4 appearance-none rounded border border-gray-200 dark:border-gray-800 accent-primary checked:appearance-auto dark:accent-primary focus:border-primary-300 focus:ring-0 focus:ring-offset-0 focus:ring-primary-200 focus:ring-opacity-50 me-2" type="checkbox" value="" id="savenexttime"/>
                                                            <label className="form-check-label text-slate-400" htmlFor="savenexttime">Checkbox 2</label>
                                                        </div>
                
                                                        <div className="flex items-center w-full mb-0">
                                                            <input className="form-checkbox size-4 appearance-none rounded border border-gray-200 dark:border-gray-800 accent-primary checked:appearance-auto dark:accent-primary focus:border-primary-300 focus:ring-0 focus:ring-offset-0 focus:ring-primary-200 focus:ring-opacity-50 me-2" type="checkbox" disabled value="" id="checkbox-d"/>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="block">
                                                            <div>
                                                                <label className="inline-flex items-center">
                                                                    <input type="radio" className="form-radio size-4 appearance-none rounded-full border border-gray-200 dark:border-gray-800 accent-primary checked:appearance-auto dark:accent-primary focus:border-primary-300 focus:ring-0 focus:ring-offset-0 focus:ring-primary-200 focus:ring-opacity-50 me-2" defaultChecked name="radio-colors" value="1"/>
                                                        ...
                                                        <div className="block mt-2">
                                                            <div>
                                                                <label className="inline-flex items-center">
                                                                    <input type="radio" className="form-radio size-4 appearance-none rounded-full border border-gray-200 dark:border-gray-800 accent-primary checked:appearance-auto dark:accent-primary focus:border-primary-300 focus:ring-0 focus:ring-offset-0 focus:ring-primary-200 focus:ring-opacity-50 me-2" name="radio-colors" value="1"/>
                                                        ...
                                                        <div className="block mt-2">
                                                            <div>
                                                                <label className="inline-flex items-center">
                                                                    <input type="radio" className="form-radio size-4 appearance-none rounded-full border border-gray-200 dark:border-gray-800 accent-primary checked:appearance-auto dark:accent-primary focus:border-primary-300 focus:ring-0 focus:ring-offset-0 focus:ring-primary-200 focus:ring-opacity-50 me-2" disabled name="radio-colors" value="1"/>
                            ...
                            <div className="" id="borders">
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-4 space-y-4">
                                                <li className="inline-block border-0 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-0</li>
                                                <li className="inline-block border-2 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-2</li>
                                                <li className="inline-block border-4 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-4</li>
                                                <li className="inline-block border-8 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-8</li>
                                                <li className="inline-block border dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border</li>
                                                <li className="inline-block border-t dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-t</li>
                                                <li className="inline-block border-s dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-s</li>
                                                <li className="inline-block border-b dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-b</li>
                                                <li className="inline-block border-e dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-e</li>
                                                <li className="inline-block border-x dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-x</li>
                                                <li className="inline-block border-y dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-y</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none space-x-4 space-y-4">
                                                <li className="inline-block border-solid border-2 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-solid</li>
                                                <li className="inline-block border-dashed border-2 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-dashed</li>
                                                <li className="inline-block border-dotted border-2 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-dotted</li>
                                                <li className="inline-block border-double border-4 dark:border-gray-800 sm:w-37.5 py-2 px-3 m-0.5 bg-white dark:bg-slate-900 text-slate-400">.border-double</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="tracking-[0.5px] mb-0 inline-flex items-center">
                                                <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-primary"><Link href="/">Techwind</Link></li>
                                                ...
                                                <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-primary"><Link href="">Components</Link></li>
                                                <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><MdKeyboardArrowRight/></li>
                                                <li className="inline-block uppercase text-[13px] font-bold text-primary" aria-current="page">Typography</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <nav aria-label="Page navigation example">
                                                <ul className="inline-flex items-center -space-x-px">
                                                    <li>
                                                        <Link href="#" className="size-10 inline-flex justify-center items-center text-slate-400 bg-white dark:bg-slate-900 rounded-s-lg hover:text-white border border-gray-100 dark:border-gray-700 hover:border-primary dark:hover:border-primary hover:bg-primary dark:hover:bg-primary">
                                                            <MdKeyboardArrowLeft className="text-[20px] rtl:rotate-180 rtl:-mt-1"/>
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#" className="size-10 inline-flex justify-center items-center text-slate-400 hover:text-white bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-700 hover:border-primary dark:hover:border-primary hover:bg-primary dark:hover:bg-primary">1</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#" className="size-10 inline-flex justify-center items-center text-slate-400 hover:text-white bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-700 hover:border-primary dark:hover:border-primary hover:bg-primary dark:hover:bg-primary">2</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#" aria-current="page" className="z-10 size-10 inline-flex justify-center items-center text-white bg-primary border border-primary">3</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#" className="size-10 inline-flex justify-center items-center text-slate-400 hover:text-white bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-700 hover:border-primary dark:hover:border-primary hover:bg-primary dark:hover:bg-primary">4</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#" className="size-10 inline-flex justify-center items-center text-slate-400 hover:text-white bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-700 hover:border-primary dark:hover:border-primary hover:bg-primary dark:hover:bg-primary">5</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#" className="size-10 inline-flex justify-center items-center text-slate-400 bg-white dark:bg-slate-900 rounded-e-lg hover:text-white border border-gray-100 dark:border-gray-700 hover:border-primary dark:hover:border-primary hover:bg-primary dark:hover:bg-primary">
                            ...
                            <div className="" id="modals">
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md" onClick={() => setModal(!modal)}>
                                                Modal
                                            </Link>
                                                ...
                                                <div className="relative w-full h-auto max-w-lg p-4">
                                                    <div className="relative bg-white dark:bg-slate-900 rounded-lg shadow-sm dark:shadow-gray-800">
                                                        ...
                                                        <div className="p-6 py-10 text-center">
                                                            ...
                                                            <Link href="" className="py-1.25 px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-transparent hover:bg-primary border border-primary text-primary hover:text-white rounded-md mt-2">Create a new wishlist</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table className="w-full text-start">
                                                    ...
                                                    <tbody>
                                                        <tr className="border-t border-gray-100 dark:border-gray-700">
                                                            ...
                                                            <td className="p-4 text-end"><span className="bg-primary/5 text-primary text-xs font-bold px-2.5 py-0.5 rounded h-5">Watch Free</span></td>
                                                        </tr>
                                ...
                                <div className="grid grid-cols-1 gap-7.5">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            ...
                                            <p className="text-slate-400">There are 280+ feather icons and you can get all icons info from here: <Link href="https://feathericons.com/" target="_blank"><code className="text-primary">https://feathericons.com/</code></Link></p>
                                            ...
                                            <p className="text-slate-400">There are 4400+ Material Design icons and you can get all icons info from here: <Link href="https://materialdesignicons.com/" target="_blank"><code className="text-primary">https://materialdesignicons.com/</code></Link></p>
                                            ...
                                            <p className="text-slate-400">There are 2200+ React Icons and you can get all icons info from here: <Link href="https://react-icons.github.io/react-icons/search" target="_blank"><code className="text-primary">https://react-icons.github.io/react-icons/search</code></Link></p>
                                            <h6 className="text-slate-400 mb-4 pb-2">Ex. <code className="text-red-600"><br/>&lt;FaBeer className= &quot; size-7 &quot; /&gt;</code></h6>
                                            <span className="text-lg text-primary me-2"><TbPhotoPlus className="inline"/></span>
                                            <span className="text-lg text-primary me-2 "><AiOutlineAndroid className="inline"/></span>
                                            <span className="text-lg text-primary me-2"><RiBitCoinLine className="inline"/></span>
                                            <span className="text-lg text-primary me-2"><MdOutlineCalendarMonth className="inline"/></span>
                                            <span className="text-lg text-primary"><AiOutlinePieChart className="inline"/></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
