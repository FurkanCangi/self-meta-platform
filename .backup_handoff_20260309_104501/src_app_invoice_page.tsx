            ...
            <div className="layout-specing">
                <div className="md:flex justify-between items-center">
                    ...
                    <ul className="tracking-[0.5px] inline-flex items-center sm:mt-0 mt-3">
                        ...
                        <li className="inline-block capitalize text-[14px] font-bold text-primary dark:text-white" aria-current="page">Invoice</li>
                    </ul>
                </div>
                                    ...
                                    <div className="md:flex justify-between">
                                        <div>
                                            ...
                                            <div className="flex mt-4">
                                                ...
                                                <Link href="https://1.envato.market/techwind-next" target="_blank" className="text-primary dark:text-white font-medium">https://1.envato.market/techwind-next</Link>
                                            </div>
                                        </div>
                                    ...
                                    <div className="md:flex justify-between">
                                        ...
                                        <div className="mt-4 md:mt-0">
                                            <div className="text-slate-400 text-center md:text-end">
                                                <h6 className="mb-0"><Link href="/page-terms" target="_blank" className="text-primary">Terms & Conditions</Link></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
