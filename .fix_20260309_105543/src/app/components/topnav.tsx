                        ...
                        <li className="dropdown inline-block relative">
                            ...
                            <div className={`dropdown-menu absolute start-0 m-0 mt-4 z-10 w-36 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 ${country ? "" : 'hidden'}`}>
                                <ul className="list-none py-2 text-start">
                                    <li className="my-1">
                                        <Link href="" className="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/germany.png'  width={24} height={24} className="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""/> German</Link>
                                    </li>
                                    <li className="my-1">
                                        <Link href="" className="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/italy.png' width={24} height={24} className="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""/> Italian</Link>
                                    </li>
                                    <li className="my-1">
                                        <Link href="" className="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/russia.png' width={24} height={24} className="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""/> Russian</Link>
                                    </li>
                                    <li className="my-1">
                                        <Link href="" className="flex items-center text-[15px] font-semibold py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/spain.png' width={24} height={24} className="size-6 rounded-full me-2 shadow-sm dark:shadow-gray-700" alt=""/> Spanish</Link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div className={`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-60 rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700  ${cart ? "" : 'hidden'}`}>
                                <ul className="py-3 text-start">
                                    ...
                                    <li className="py-1.5 px-4 space-x-1">
                                        <Link href="#" className="py-1.25 px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center rounded-md bg-primary hover:bg-primary-700 border border-primary hover:border-primary-700 text-white">View Cart</Link>
                                        <Link href="#" className="py-1.25 px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center rounded-md bg-primary hover:bg-primary-700 border border-primary hover:border-primary-700 text-white">Checkout</Link>
                                        ...
                                        <li>
                                            <Link href="#!" className="block font-medium py-1.5 px-4">
                                                <div className="flex items-center">
                                                    <div className="size-10 rounded-md shadow-sm shadow-primary/10 dark:shadow-gray-700 bg-primary/10 dark:bg-slate-800 text-primary dark:text-white flex items-center justify-center">
                                                        <Icon.ShoppingCart className="size-4"/>
                                                    </div>
                                                    <div className="ms-2">
                        ...
                        <li className="dropdown inline-block relative">
                            ...
                            <div className={`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 ${user ? '' : 'hidden'}`} >
                                <ul className="py-2 text-start">
                                    <li>
                                        <Link href="/profile" className="flex items-center font-medium py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><AiOutlineUser className="me-2"/>Profile</Link>
                                    </li>
                                    <li>
                                        <Link href="/chat" className="flex items-center font-medium py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><FaRegComment className="me-2"/>Chat</Link>
                                    </li>
                                    <li>
                                        <Link href="/email" className="flex items-center font-medium py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><MdMailOutline className="me-2"/>Email</Link>
                                    </li>
                                    <li>
                                        <Link href="/profile-setting" className="flex items-center font-medium py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><AiOutlineSetting className="me-2"/>Settings</Link>
                                    </li>
                                    <li className="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                                    <li>
                                        <Link href="/lock-screen" className="flex items-center font-medium py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><BiLockAlt className="me-2"/>Lockscreen</Link>
                                    </li>
                                    <li>
                                        <Link href="/login" className="flex items-center font-medium py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><IoMdLogOut className="me-2"/>Logout</Link>
                                    </li>
                                </ul>
                            </div>
                        </li>
