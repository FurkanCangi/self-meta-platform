                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style={{padding: '15px 24px 15px', color: '#8492a6'}}>
                                Thanks for creating an Self Metacognition Institute account. To continue, please confirm your email address by clicking the button below :
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style={{padding: '15px 24px 15px', color: '#8492a6',}}>
                                Self Metacognition Institute <br/> Support Team
                            </td>
                        </tr>
        
                        <tr>
                            <td style={{padding: '16px 8px', color: '#8492a6', backgroundColor: '#f8f9fc', textAlign: 'center'}}>
                                © {new Date().getFullYear()}Self Metacognition Institute.
                            </td>
                        </tr>
                    </tbody>
                </table>
