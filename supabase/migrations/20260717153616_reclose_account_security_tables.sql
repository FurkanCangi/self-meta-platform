-- Supabase history version: 20260717183232.
-- A later live-only migration restored browser SELECT access to these tables.
-- Device and account-security data is intentionally served only by the
-- authenticated server APIs, where the exact trusted app session is checked.
