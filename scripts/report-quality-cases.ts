...
export const QUALITY_CASE_SPECS: QualityCaseSpec[] = [
  ...
  },
  {
    ...
    mode: "widespread",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Yürütücü-Duygusal", "Self-Regülasyon Problemi"],
  ...
  },
  {
    ...
    mode: "widespread",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Fizyolojik Toparlanma", "Self-Regülasyon Problemi"],
    forbiddenPhrases: ["seçici bir kırılganlık"],
    minLiteratureParagraphs: 3,
    minApaReferences: 4,
  },
  ...
  },
  {
    ...
    mode: "widespread",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Motor Planlama", "Beden Organizasyonu", "Self-Regülasyon Problemi"],
  ...
  },
  {
    ...
    mode: "widespread",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Dilsel", "Sosyal-Pragmatik", "Self-Regülasyon Problemi"],
  ...
  },
  {
    ...
    mode: "widespread",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Yürütücü", "Self-Regülasyon Problemi"],
  ...
  },
  {
    ...
    mode: "widespread",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Günlük Yaşam", "Öz Bakım", "Self-Regülasyon Problemi"],
  ...
  },
  {
    ...
    mode: "widespread",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Motor", "Self-Regülasyon Problemi"],
  ...
  },
  {
    ...
    mode: "paired",
    expectedGlobalLevel: "Riskli",
    expectedProfileIncludes: ["Dilsel", "Self-Regülasyon Problemi"],
