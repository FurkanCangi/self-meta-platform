...
export const PREOPEN_RECEIPT_SCHEMA = "dna-turkish-retrieval-v2-preopen-overlap-receipt@1"
export const PREOPEN_MANIFEST_SCHEMA = "dna-turkish-retrieval-v2-preopen-overlap-manifest@1"
...
export function analyzeOverlap(developmentQuestions, holdoutQuestions) {
  if (!Array.isArray(developmentQuestions) || !Array.isArray(holdoutQuestions)
    ...
    fail("dna_v2_preopen_question_input_invalid")
  }
...
export function assertZeroOverlap(overlap) {
  ...
  ], "dna_v2_preopen_overlap_fields_invalid")
  if (Object.values(overlap).some((value) => value !== 0)) {
    fail("dna_v2_preopen_overlap_nonzero")
  }
  return overlap
}
...
export function assertPreopenReceipt(receipt) {
  ...
  ], "dna_v2_preopen_receipt_fields_invalid")
  if (receipt.schemaVersion !== PREOPEN_RECEIPT_SCHEMA
    ...
    fail("dna_v2_preopen_receipt_identity_invalid")
  }
  assertExactKeys(receipt.inputBindings, [
    "holdoutArtifactSha256", "holdoutFileSha256", "holdoutManifestFileSha256",
    "developmentBankSha256", "developmentBankFileSha256",
    "developmentManifestFileSha256", "allowedLegacyQaFileSha256",
    "integrityScriptFileSha256", "integrityCoreFileSha256",
  ], "dna_v2_preopen_receipt_binding_fields_invalid")
  for (const hash of Object.values(receipt.inputBindings)) {
    assertSha256(hash, "dna_v2_preopen_receipt_binding_hash_invalid")
  }
  assertExactKeys(receipt.counts, [
    "holdoutQuestions", "developmentQuestions", "newDevelopmentQuestions",
    "allowedLegacyQuestions",
  ], "dna_v2_preopen_receipt_count_fields_invalid")
  if (receipt.counts.holdoutQuestions !== 196 || receipt.counts.developmentQuestions !== 708
    || receipt.counts.newDevelopmentQuestions !== 560
    || receipt.counts.allowedLegacyQuestions !== 148) {
    fail("dna_v2_preopen_receipt_counts_invalid")
  }
  assertZeroOverlap(receipt.overlap)
  assertExactKeys(receipt.methods, [
    "exact", "normalized", "nearDuplicate", "semanticFamily",
  ], "dna_v2_preopen_receipt_method_fields_invalid")
  ...
  ], "dna_v2_preopen_receipt_boundary_fields_invalid")
  if (receipt.boundaries?.aggregateOnly !== true
    ...
    fail("dna_v2_preopen_receipt_boundary_invalid")
  }
  return receipt
}
...
export function assertPreopenManifest(manifest) {
  ...
  ], "dna_v2_preopen_manifest_fields_invalid")
  if (manifest.schemaVersion !== PREOPEN_MANIFEST_SCHEMA
    ...
    fail("dna_v2_preopen_manifest_identity_invalid")
  }
  assertSha256(manifest.receipt?.rawSha256, "dna_v2_preopen_manifest_receipt_hash_invalid")
  assertSha256(manifest.receipt?.receiptSha256, "dna_v2_preopen_manifest_receipt_hash_invalid")
