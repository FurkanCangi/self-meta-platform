...
Auditte 47 kaynak × 8 bileşen = 376 karar üretildi. Artefakt içinde lisans beyanı doğrulanan 10 kaynakta abstract/full-text/passage lisans kapısını geçti. Kalan full-text/passage kararları 20 `unknown`, 14 `restricted` ve 3 `metadata_only` olarak kapalıdır; fakat lisans uygunluğu tek başına runtime release değildir. Çıktı attribution veya ShareAlike gerektiriyorsa release derleyicisi yükümlülüğün karşılandığını notice hash'i ve uyumlu çıktı lisansı üzerinden ayrıca doğrular. Tüm tablo, şekil, ölçek ve test maddeleri 47/47 restricted tutuldu.
